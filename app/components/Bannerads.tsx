        ...
        <div>
            <div className="flex justify-between px-20">
                {split === 1 ? (
                    <div className="w-[70%] h-[400px] pt-10">
                        <Image src="/promo/whitepromo.png" className="object-cover h-[350px]" alt="banner1" width={800} height={400} />
                    </div>
                ) : (
                    <div className="w-[45%] h-[400px] pt-10">
                        <Image src="/promo/blackfriday1.png" className="object-cover object-left h-[350px]" alt="banner1" width={800} height={400} />
                    </div>
                )}
                {split === 1 ? (
            ...
            {split === 2 && (
                <div className="flex justify-between px-20 mt-10 mb-20">
                    <div className="w-[45%] h-[400px] pt-10">
                        <Image src="/promo/blackfriday2.png" className="object-cover object-right h-[350px]" alt="banner2" width={800} height={400} />
                    </div>
                    <div className="border-l border-gray-300 pt-10 pl-20">
