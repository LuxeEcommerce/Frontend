...
export default function Home() {
  return (
    <div>
      ...
      <Bannerads split={1} titleList={["Shop Now"]} descList={["Get the best deals on our products"]} />
      <Productlisting title="Explore Our Products" type="Our Products"  swiperView={false}/>   
      <Bannerads split={2} titleList={["Shop Now", "Shop Now"]} descList={["Get the best deals on our products", "Get the best deals on our products"]} />
      <Footer />
    </div>    
  );
}
